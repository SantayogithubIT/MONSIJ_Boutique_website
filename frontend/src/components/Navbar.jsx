...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium' >
     <Link to='/'> <img src={assets.Mon_logo} className='h-20 w-24' alt="" /> </Link>
    <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
        ...
        <div onClick={()=> token ? null : navigate('/login')} className='group relative'><img src={assets.profile_icon} className='w-4 cursor-pointer' alt="Your profile" />
